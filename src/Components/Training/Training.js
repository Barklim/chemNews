...
const topbar = {
   /* background: "#DA4453", */ /* fallback for old browsers */
    ...
    background: "linear-gradient(to left, #89216B, #35C0CD)", /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    top: 0,
    position: "fixed",
    width: "100%",
    zIndex: 100,
...
const Training = ({searchInput, fruitlist, ratingChanged, snackClose, snackOpener}) => {
	...
	return (
		<div>
            ...
            <div className='rate_comp_header'> Most popular results:</div>
			<div style={style}>	
			{
